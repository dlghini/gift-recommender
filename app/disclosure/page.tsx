  ...
  return (
    <div className="min-h-screen bg-amber-50">
      ...
      <main className="max-w-2xl mx-auto px-4 py-12">
        ...
        <p className="text-stone-400 text-sm mb-10">Last updated: May 31, 2026</p>
        ...
        <div className="space-y-6 text-stone-600 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              When you click a &quot;Buy now&quot; button on our results page, you will be directed
          ...
          <section>
            ...
            <p>
              ...
              are generated by Claude AI based solely on the information you provide in the
              wizard — the recipient&apos;s relationship, age, occasion, interests, and your budget.
              No advertiser or affiliate partner has any input into our recommendations.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Prices shown are estimates generated by our AI and may differ from current Amazon
              prices. Always check the product page for the actual price before purchasing.
